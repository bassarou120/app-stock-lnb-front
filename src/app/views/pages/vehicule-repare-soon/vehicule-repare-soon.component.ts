...
@Component({
  ...
  templateUrl: 'vehicule-repare-soon.component.html',

})
export class VehiculeRepareSoon implements OnInit {
  ...
  reparations_recentes: InterventionVehicule[] = [];
  ...
  ngOnInit(): void {
    ...
    //if (this.hasPageAccess) {
      this.loadVehiculesEntretenusoon();
    //}
  }
...
loadVehiculesEntretenusoon(): void {
  this.dashboardStockService.getVehiculesEntretenusoon().subscribe(
    (data) => {
      this.reparations_recentes = data;
